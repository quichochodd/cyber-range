<#
.SYNOPSIS
    This PowerShell script ensures that logon is required in order to access the machine's camera.
    This ensures that the device is only used by authorized personnel.
