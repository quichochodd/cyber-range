<#
.SYNOPSIS
    This PowerShell script enforces prompting a client for their password upon connection with Remote Desktop Services.
...
# Alert if not running as Administrator
if (-not (Check-Admin)) {
